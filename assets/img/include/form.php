...
$toemails[] = array(
		 	'email' => 'info@dmedigital.com.ar', 
		//	'email' => 'depetrinicolas@gmail.com',
...
$recaptcha_secret = '6LcvstcUAAAAAC7u3G1fh2COpnq8puxXNs68mqg-'; // Your reCaptcha Secret
...
if( $_SERVER['REQUEST_METHOD'] == 'POST' ) {
	...
	$html_title	= !empty( $submits['html_title'] ) ? $submits['html_title'] : 'Email desde la web';
	...
	if( $sendEmail == true ):
		...
		echo "<script>
		alert('Recibimos correctamente tu mensaje, te responderemos en unos minutos!');
